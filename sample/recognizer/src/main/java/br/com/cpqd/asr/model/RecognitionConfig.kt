...
class RecognitionConfig {
    ...
    private fun setPartialResultEnabled(partialResultEnabled: Boolean?) {
        if(partialResultEnabled != null)
            map["decoder.partialResultEnabled"] = partialResultEnabled.toString()
    }

    private fun setpPartialResultInterval(partialResultInterval: Int?) {
        if(partialResultInterval != null)
            map["decoder.partialResultInterval"] = partialResultInterval.toString()
    }
    ...
    class Builder {
        ...
        private var partialResultEnabled: Boolean? = null
        private var partialResultInterval: Int? = null
        ...
        fun partialResultEnabled(value: Boolean): Builder {
            this.partialResultEnabled = value
            return this
        }

        fun partialResultInterval(value: Int): Builder {
            this.partialResultInterval = value
            return this
        }
        ...
        fun build(): RecognitionConfig {
            ...
            config.setPartialResultEnabled(partialResultEnabled)
            config.setpPartialResultInterval(partialResultInterval)
